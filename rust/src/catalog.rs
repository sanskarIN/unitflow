/// A broad conversion category supported by UnitFlow.
...
///
/// Temperature uses dedicated affine formulas in the converter; its factor is
/// retained as `1` only for catalog consistency.
...
pub const UNITS: &[UnitDef] = &[
    ...
    UnitDef { id: "fahrenheit", category: Category::Temperature, name: "Fahrenheit", symbol: "°F", factor_to_base: "1", aliases: &["fahrenheits"], description: "Temperature scale commonly used in the United States." },
