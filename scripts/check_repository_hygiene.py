...
REQUIRED_FILES = (
    ...
    "apps/unitflow_app/analysis_options.yaml",
    ...
    "docs/unit-model.md",
    "docs/adr/0001-rust-core-flutter-ui.md",
    "docs/adr/0002-exact-decimal-arithmetic.md",
    "docs/adr/0003-local-first-persistence.md",
